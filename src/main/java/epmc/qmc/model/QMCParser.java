...
public final class QMCParser implements QMCParserConstants {
        ...
        private ModelPRISM privParseModel() throws ParseException {
                ...
                try {
                    ...
                    if (this.model == null) {
                      ...
                      result = this.model;
                        ...
                        /*for (Expression m: globalVariables.keySet()) {
...
//			result.build(contextExpQMC, model[0], null, modules, init[0], globalVariables, globalInitValues, sd[0], formulae, rewards, null, null, players);
  ...
  final private void parseConstantQmc(Formulas formulae) throws ParseException {
    ...
    jj_consume_token(NESTING_SEMICOLON_SEMICOLON);
                ...
                JANIType typeComplexArray = new JANITypeArray(typeComplex, null);
                ...
                if (isVector) {
                        if (isBra) {
                                formulae.addConstant(ids, contextExpQMC.newBraToVector(value), typeComplexArray);
                        } else {
  ...
  static {
   ...
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40100000,0x0,0x1000000,0x20,0x0,0x40000000,0x400000,0x0,0x0,0x2000,0x100000,0x2000,0x0,0x2000,0x2008408,0x2008408,0x200a408,0x21000,0x21000,0x400000,0x400000,0x8000,0x0,0x100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
